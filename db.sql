...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2017 at 09:38 AM
...
(244, 0, 237, 0, 'admin/simpan-wajib', 'Module Simpan', 'description', '2017-04-19 07:59:25', NULL, NULL, NULL),
(245, 0, 237, 0, 'admin/simpan-pokok', 'Module Simpan Pokok', 'description', '2017-04-20 16:11:28', NULL, NULL, NULL),
(246, 0, 205, 0, 'admin/config/controll-Pay', 'Controll Pay Admin', 'settings', '2017-04-22 14:23:52', NULL, NULL, NULL),
...
(1, 82, '2017-04-29 00:00:00', 9090, 'abdkjasdhaslkdasd', 'kkkkkk');
...
(22, NULL, NULL, '1970-01-01', NULL, 82, 1),
(23, NULL, NULL, '1970-01-01', NULL, 82, 1);
...
--
ALTER TABLE `menu_admin`
  MODIFY `id_menu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;
--
...
--
ALTER TABLE `menu_role`
  MODIFY `kd_role` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2129;
--
