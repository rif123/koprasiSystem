            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="block-header">
                        <h2><A href="{{url($_ENV['ADMIN_FOLDER'].'/post')}}">Post</a> > Setting</h2>
                    </div>
                                ...
                                <div class="body">
                                    ...
                                    <form name="edit" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="name" value="{{$section6_title}}" placeholder="title" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="text" value="{{$section6_background}}" class="form-control"id="imgUploadReplace" disabled/>
                                                <input type="hidden" value="{{$section6_background}}" class="form-control" name="image" id="imgUploadReplace1"/>
                                            </div>
                                        </div>
