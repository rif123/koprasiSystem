    ...
    <section class="content">
                <div class="container-fluid">
                    <div class="block-header">
                        <h2><A href="{{url($_ENV['ADMIN_FOLDER'].'/project')}}">PROJECT</a> >  ADD</h2>
                    </div>
                                ...
                                <div class="body">
                                    ...
                                    <form name="edit" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <textarea name="description" id="ckNoImage" class="form-control" placeholder="Text Box.."></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <button type="button" href="#ContentModal" data-multiple="1" data-to="#imgUploadReplaceGallery" data-to-origin="#imgUploadReplaceGallery1" data-url="/{{$_ENV['ADMIN_FOLDER']}}/mediamanager/show" class="btn bg-light-blue waves-effect OpenMediaManager">Choose from media manager</button>
                                                <input type="text" class="form-control" id="imgUploadReplaceGallery" disabled/>
                                                <input type="hidden" class="form-control" name="imagegallery" id="imgUploadReplaceGallery1"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" id="imgUploadReplace" disabled/>
                                                <input type="hidden" class="form-control" name="featuredimage" id="imgUploadReplace1"/>
                                            </div>
                                        </div>
