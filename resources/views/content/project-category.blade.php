                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div style="text-align:right;padding:5px">
                                    <a href="{{url($_ENV['ADMIN_FOLDER'].'/project/category/add')}}">
                                        ...
                                        <tbody class="table-striped">
                                            @foreach($data as $a)
                                                <tr>                                                    
                                                    <td>{{$a['name']}}</td>
                                                    <td>
                                                        <a href="{{url($_ENV['ADMIN_FOLDER'].'/project/category/edit/'.$a['category_id'])}}">
                                                            <button class="btn btn-info waves-effect" type="button">
                                                                    <i class="material-icons" style="color:white">mode_edit</i>     
                                                            </button>
                                                        </a>
                                                        <a href="{{url($_ENV['ADMIN_FOLDER'].'/project/category/delete/'.$a['category_id'])}}" class="alertButton">
