    ...
    <section class="content">
                <div class="container-fluid">
                    <div class="block-header">
                        <h2><A href="{{url($_ENV['ADMIN_FOLDER'].'/carousel')}}">CAROUSEL</a> >  ADD</h2>
                    </div>
                                ...
                                <div class="body">
                                    ...
                                    <form name="add" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="toptext" placeholder="Top Text" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="middletext" placeholder="Middle Text" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="buttontext" placeholder="Button Text" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="buttonlink" placeholder="Button Link" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" class="form-control" name="image" id="imgUploadReplace1"/>
                                            </div>
                                        </div>
