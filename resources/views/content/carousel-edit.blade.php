    ...
    <section class="content">
                <div class="container-fluid">
                    <div class="block-header">
                        <h2><A href="{{url($_ENV['ADMIN_FOLDER'].'/carousel')}}">CAROUSEL</a> >  Edit</h2>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <form name="edit" method="POST" enctype="multipart/form-data">
                                        ...
                                        <h2 class="card-inside-title">Top Text</h2>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="material-icons">toc</i>
                                            </span>
                                            <div class="form-line">
                                                <input type="text" value="{{$text_top}}" class="form-control" name="toptext" placeholder="Top Text" />
                                            </div>
                                        </div>
                                        <h2 class="card-inside-title">Middle Text</h2>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="material-icons">toc</i>
                                            </span>
                                            <div class="form-line">
                                                <input type="text" value="{{$text_middle}}" class="form-control" name="middletext" placeholder="Middle Text" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" value="{{$button_text}}" class="form-control" name="buttontext" placeholder="Button Text" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" value="{{$button_link}}" class="form-control" name="buttonlink" placeholder="Button Link" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="text" value="{{$image}}" class="form-control"id="imgUploadReplace" disabled/>
                                                <input type="hidden" value="{{$image}}" class="form-control" name="image" id="imgUploadReplace1"/>
                                            </div>
                                        </div>
