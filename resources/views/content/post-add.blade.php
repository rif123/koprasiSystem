    ...
    <section class="content">
                <div class="container-fluid">
                    <div class="block-header">
                        <h2><A href="{{url($_ENV['ADMIN_FOLDER'].'/post')}}">POST</a> >  ADD</h2>
                    </div>
                                ...
                                <div class="body">
                                    ...
                                    <form name="edit" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <textarea name="description" id="ckeditor" class="form-control" placeholder="Text Box.."></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="switch">
                                            <label>No<input name="active" type="checkbox" checked><span class="lever"></span>Yes</label>
                                        </div>
