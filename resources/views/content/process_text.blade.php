                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div style="text-align:right;padding:5px">
                                    <a href="{{url($_ENV['ADMIN_FOLDER'].'/process_text/add')}}">
                                        <button type="button" class="btn btn-success waves-effect">
                                           <i class="material-icons">add_box</i>
                                        </button>
                                    </a>
                                    <a href="{{url($_ENV['ADMIN_FOLDER'].'/process_text/setting')}}">
                                        ...
                                        <tbody class="table-striped">
                                            @foreach($data as $a)
                                                <tr>                                                    
                                                    <td>{{$a['title']}}</td>
                                                    <td>
                                                        <a href="{{url($_ENV['ADMIN_FOLDER'].'/process_text/edit/'.$a['id'])}}">
                                                            <button class="btn btn-info waves-effect" type="button">
                                                                    <i class="material-icons" style="color:white">mode_edit</i>     
                                                            </button>
                                                        </a>
                                                        <a href="{{url($_ENV['ADMIN_FOLDER'].'/process_text/delete/'.$a['id'])}}" class="alertButton">
