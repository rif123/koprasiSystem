    ...
    <section class="content">
                <div class="container-fluid">
                    <div class="block-header">
                        <h2><A href="{{url($_ENV['ADMIN_FOLDER'].'/user_level')}}">USER LEVEL</a> >  ADD</h2>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <form name="edit" method="POST">
                                        <h2 class="card-inside-title">Group Name</h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach($data as $a)
                                                <input id="{{$a->name}}" type="checkbox" name="rules[]" value="{{$a->url_slug}}">
