    ...
    <div class="input-group">
        <div class="form-line">
            <input type="text" class="form-control" name="noHp_pribadi" value="" placeholder="No Handphone / Wa" />
        </div>
    </div>
    <h2 class="card-inside-title">Email</h2>
    <div class="input-group">
        <div class="form-line">
            <input type="text" class="form-control" name="email_pribadi" value="" placeholder="Email" />
        </div>
    </div>
    <h2 class="card-inside-title">Alamat</h2>
    <div class="input-group">
        <div class="form-line">
            <input type="text" class="form-control" name="alamat_pribadi" value="" placeholder="Alamat" />
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
        ...
        <div class="form-group form-float">
            <div class="form-line">
                <input type="text" class="form-control" name="rtRw_pribadi">
