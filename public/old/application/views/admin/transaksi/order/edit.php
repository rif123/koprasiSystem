...
<ul class="breadcrumb">
	...
	<li>Pesanan</li>
	<li class="divider"></li>
	<li>Ubah Status Pesanan</li>
</ul>
<div class="separator bottom"></div>
<div class="innerLR">

<form class="form-horizontal" id="form_input" method="POST" action="<?=site_url('order/update')?>">
	<!-- Widget -->
        <div class="widget widget-gray widget-body-gray">
                <!-- Widget heading -->
                <div class="widget-head"><h4 class="heading">Ubah Status Pesanan</h4></div>
                <!-- // Widget heading END -->
                <div class="widget-body">
						...
						<div id="sub_table">
							<table class="table" width="100%">
								...
								<?php } ?>
								 <tr><td><button type="submit" class="btn btn-icon btn-primary glyphicons circle_ok"><i></i>Proses</button></td><td></td></tr>
							</table>
						</div>
                </div>
