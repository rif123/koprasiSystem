...
<div class="box">
	<div class="box-title">
		<h3><i class="icon-table"></i>Tambah Template</h3>
			<div class="box-tool">
	...
	<div class="box-content">
		...
		<form id="form_input" action="<?=site_url('template/save')?>" class="form-horizontal" enctype="multipart/form-data"  method="post">
			<div class="form-group">
				<label class="col-sm-3 col-lg-2 control-label" for="no_account">Nama Template:</label>
				<div class="col-sm-6 col-lg-4 controls">
				<input name="nm_template" id="nm_template" class="form-control" type="text">
				</div>
			</div>
			<div class="form-group">
					...
					<select class="form-control" name="code_paket" id="code_paket">
						<?php
							foreach($tb_paket->result() as $w){
								echo"<option value='".$w->code."'>".$w->nm_paket."</option>";
							}
						?>
					</select>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-lg-10 controls">
					<textarea class="form-control" rows="3" name='description' style='height:200px;'></textarea>
				</div>
			</div>
