...
$(document).ready(function() {
    $('#list').dataTable( {
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?=site_url('template/list_template')?>"
    } );
} );
</script>
<div class="col-md-12">
<div class="box">
	<div class="box-title">
		<h3><i class="icon-table"></i>Management Template</h3>
			<div class="box-tool">
...
<div class="box-content">
		<div class="btn-toolbar pull-right clearfix">
			<div class="btn-group">
				<a data-original-title="Add new record" class="btn btn-primary button-next show-tooltip" title="" href="<?=site_url('template/add')?>">Add</a>
