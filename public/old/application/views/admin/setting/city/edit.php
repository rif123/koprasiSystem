...
<form class="form-horizontal" id="form_input" method="POST" action="<?=site_url('setting/update/city')?>">
	<!-- Widget -->
        <div class="widget widget-gray widget-body-gray">
                <!-- Widget heading -->
                <div class="widget-head"><h4 class="heading">Edit Daftar Kota</h4><a href="<?=site_url('setting/city')?>" style="float:right;margin-right: 1em;font-weight: bold;">Kembali</a></div>
                <!-- // Widget heading END -->
                        ...
                        <!-- Column -->
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"> 
													<input  value="<?=$Result_form->idx_shipping_location?>" id="idx_shipping_location" name="idx_shipping_location" type="hidden">
													<input class="form-control" value="<?=$Result_form->provinsi?>" id="provinsi" name="provinsi" type="text">
												</div>
                                        </div>
                                        <!-- // Group END -->
                                        <!-- Group -->
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->kota?>" id="kota" name="kota" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="kec">Kecamatan:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->kec?>" id="kec" name="kec" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="city_code">Kode Kota:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->city_code?>" id="city_code" name="city_code" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="zona">Zona:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->zona?>" id="zona" name="zona" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
                                </div>
                                <!-- // Column END -->
