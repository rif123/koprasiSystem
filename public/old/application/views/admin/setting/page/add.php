...
<div class="box">
	<div class="box-title">
		<h3><i class="icon-table"></i>Tambah Page</h3>
			<div class="box-tool">
	...
	<div class="box-content">
		...
		<form id="form_input" action="<?=site_url('setting/save/page')?>" class="form-horizontal" enctype="multipart/form-data"  method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-lg-10 controls">
					<textarea class="form-control" rows="3" name='text_content' style='height:200px;'></textarea>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9 col-lg-10 controls">
					<label class="radio-inline">
						<input type="radio" name="fl_share" value="1"> Yes
					</label>
					<label class="radio-inline">
						<input type="radio" name="fl_share" value="0" checked="">No
					</label>  
				</div>
			</div>
			<div class="form-group">
