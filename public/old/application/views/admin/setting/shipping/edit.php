...
<form class="form-horizontal" id="form_input" method="POST" action="<?=site_url('setting/update/shipping')?>">
	<!-- Widget -->
        <div class="widget widget-gray widget-body-gray">
                <!-- Widget heading -->
                <div class="widget-head"><h4 class="heading">Edit Ongkos Kirim</h4><a href="<?=site_url('setting/shipping')?>" style="float:right;margin-right: 1em;font-weight: bold;">Kembali</a></div>
                <!-- // Widget heading END -->
                        ...
                        <!-- Column -->
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"> 
													<input  value="<?=$Result_form->idx_shipping_price?>" id="idx_shipping_price" name="idx_shipping_price" type="hidden">
													<input class="form-control" value="<?=$Result_form->city_code?>" id="city_code" style="width:50%;" name="city_code" type="text">
												</div>
                                        </div>
                                        <!-- // Group END -->
                                        <!-- Group -->
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->a_reg?>" id="a_reg" name="a_reg" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="a_oke">Ongkir Zona A OKE:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->a_oke?>" id="a_oke" name="a_oke" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="a_yes">Ongkir Zona A YES:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->a_yes?>" id="a_yes" name="a_yes" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="b_reg">Ongkir Zona B Reguler:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->b_reg?>" id="b_reg" name="b_reg" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="b_oke">Ongkir Zona B OKE:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->b_oke?>" id="b_oke" name="b_oke" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="b_yes">Ongkir Zona B YES:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->b_yes?>" id="b_yes" name="b_yes" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
                                </div>
                                <!-- // Column END -->
								<div class="col-md-6">
									 <!-- Group -->
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->c_reg?>" id="c_reg" name="c_reg" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="c_oke">Ongkir Zona C OKE:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->c_oke?>" id="c_oke" name="c_oke" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="c_yes">Ongkir Zona C YES:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->c_yes?>" id="c_yes" name="c_yes" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="d_reg">Ongkir Zona D Reguler:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->d_reg?>" id="d_reg" name="d_reg" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="d_oke">Ongkir Zona D OKE:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->d_oke?>" id="d_oke" name="d_oke" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
										 <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="d_yes">Ongkir Zona D YES:</label>
                                                <div class="col-md-8"><input class="form-control" value="<?=$Result_form->d_yes?>" id="d_yes" name="d_yes" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
								</div>
                           </div>
