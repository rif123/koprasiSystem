...
<form class="form-horizontal" id="frm_input" method="POST" action="<?=site_url('setting/upload_ongkir')?>" enctype="multipart/form-data">
	<!-- Widget -->
        <div class="widget widget-gray widget-body-gray">
                <!-- Widget heading -->
                <div class="widget-head"><h4 class="heading">Upload Ongkos Kirim</h4><a href="<?=site_url('setting/shipping')?>" style="float:right;margin-right: 1em;font-weight: bold;">Kembali</a></div>
                <!-- // Widget heading END -->
                        ...
                        <!-- Column -->
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"><input class="form-control" name="path_ongkir" type="file"></div>
                                        </div>
                                        <!-- // Group END -->
                                </div>
                                <!-- // Column END -->
