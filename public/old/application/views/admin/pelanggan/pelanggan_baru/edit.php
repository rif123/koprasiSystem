...
<div class="box">
	<div class="box-title">
		<h3><i class="icon-table"></i>Edit Account</h3>
			<div class="box-tool">
	...
	<div class="box-content">
		...
		<form id="form_input" action="<?=site_url('setting/update/account')?>" class="form-horizontal"  method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-6 col-lg-4 controls">
					<input name="no_account" id="no_account" value="<?=$Result_form->no_account?>" class="form-control" type="text">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 col-lg-2 control-label">Keterangan:</label>
				<div class="col-sm-9 col-lg-10 controls">
					<textarea class="form-control" rows="3" name='keterangan'><?=$Result_form->keterangan?></textarea>
				</div>
			</div>
			<div class="form-group">
