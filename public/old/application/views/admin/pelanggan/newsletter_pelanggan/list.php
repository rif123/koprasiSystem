...
$(document).ready(function() {
    $('#List').dataTable( {
        ...
        "bServerSide": true,
        "sAjaxSource": "<?=site_url('pelanggan/list_content_newsletter')?>"
    } );
} );
</script>
<!--Content-->
<div id="content">
	<ul class="breadcrumb">
			<li><a href="#">Home</a></li>
			<li class="divider"></li>
			<li>Newsletter Pelanggan</li>
	</ul>
		<div class="col-md-12">
				<div class="innerLR">
					<div class="widget widget-4">
						<div class="widget-head">
							<h4 style='margin-left: -15px;' class="heading">Newsletter Pelanggan</h4>
						</div>
						<div class="widget-body">
						<div>
						<a href="<?=site_url('pelanggan/tulis_newsletter')?>" class="btn btn-block btn-primary" style='margin: 8px -1em;width:6em;'>Tambah</a>
						</div>
