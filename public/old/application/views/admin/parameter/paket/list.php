...
$(document).ready(function() {
    $('#list').dataTable( {
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?=site_url('parameter/list_paket')?>"
    } );
} );
</script>
<div class="col-md-12">
...
<div class="box-content">
		<div class="btn-toolbar pull-right clearfix">
			<div class="btn-group">
				<a data-original-title="Add new record" class="btn btn-primary button-next show-tooltip" title="" href="<?=site_url('parameter/add/paket')?>">Add</a>
