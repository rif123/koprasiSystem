...
<form class="form-horizontal" id="form_input" method="POST" onSubmit="tinyMCE.triggerSave();" action="<?=site_url('parameter/save/page')?>"  enctype="multipart/form-data">
	<!-- Widget -->
        <div class="widget widget-gray widget-body-gray">
                <!-- Widget heading -->
                <div class="widget-head"><h4 class="heading">Tambah Page</h4><a href="<?=site_url('parameter/page')?>" style="float:right;margin-right: 1em;font-weight: bold;">Kembali</a></div>
                <!-- // Widget heading END -->
                        ...
                        <!-- Column -->
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"><input class="form-control" id="nm_page" name="nm_page" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
                                        
                                        <!-- Group -->
                                        <div class="form-group">
                                                <label class="col-md-4 control-label" for="atas_nama">Content</label>
                                                <div class="col-md-8"><textarea style='width:50em;height:20em;' name="content" ></textarea></div>
                                        </div>
                                        <!-- // Group END -->
                                  </div>
                                <!-- // Column END -->
