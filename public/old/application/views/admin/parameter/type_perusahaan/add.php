...
<div class="box">
	<div class="box-title">
		<h3><i class="icon-table"></i>Tambah Tipe Perusahaan</h3>
			<div class="box-tool">
	...
	<div class="box-content">
		...
		<form id="form_input" action="<?=site_url('parameter/save/type_perusahaan')?>" class="form-horizontal" enctype="multipart/form-data"  method="post">
