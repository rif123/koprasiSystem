...
<ul class="breadcrumb">
	...
	<li>Brand Produk</li>
	<li class="divider"></li>
	<li>Tambah Brand Produk</li>
</ul>
<div class="separator bottom"></div>
<div class="innerLR">

<form class="form-horizontal" id="form_input" method="POST" action="<?=site_url('product/save/brand')?>" enctype="multipart/form-data">
	<!-- Widget -->
        <div class="widget widget-gray widget-body-gray">
                <!-- Widget heading -->
                <div class="widget-head"><h4 class="heading">Tambah Brand Produk</h4></div>
                <!-- // Widget heading END -->
                        ...
                        <!-- Column -->
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-8"><input class="form-control" id="nm_brand" name="nm_brand" type="text"></div>
                                        </div>
                                        <!-- // Group END -->
                                </div>
                                <!-- // Column END -->
